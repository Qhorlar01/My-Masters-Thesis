/************************ dSPACE target specific file *************************
   ...
   Include file .\PWM_withSlaveBITOUT_rti1104\PWM_withSlaveBITOUT_th.c :

   Task Configuration file for model : PWM_withSlaveBITOUT

   RTI1104 23.1 (02-May-2023)/2.20
   17-Jul-2025 17:59:19
...
/* ===== List of model tasks and assigned interrupt sources ================
   ...
   Timer Task 1 [5e-05 0] s       : Timer A interrupt
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\PWM_withSlaveBITOUT_rti1104\PWM_withSlaveBITOUT_th.c is for ST).
# endif
...
/* Initialize dynamically generated services */
  ...
  rtith_bind_interrupt( /* --- Bind interrupt to task. ----- */
      ...
      pTask1,             /*  Task (TCB pointer).              */
      (5e-05 * RTI_TIMER_TASK_TIME_SCALE),             /*  Sample time or period.           */
      C_LOCAL,             /*  RTK channel.                     */

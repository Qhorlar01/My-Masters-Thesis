/*********************** dSPACE target specific file *************************
   ...
   Include file PWM_withSlaveBITOUT_rti.c:
...
#define RTB_STRUCTURE_NAME             PWM_withSlaveBITOUT_B
#define RTP_STRUCTURE_NAME             PWM_withSlaveBITOUT_P
...
static void rti_mdl_initialize_io_boards(void)
{
  ...
  ds1104_slave_dsp_bit_io_init(1, 2, SLVDSP1104_BIT_IO_BIT4_MSK|
    SLVDSP1104_BIT_IO_BIT1_MSK, SLVDSP1104_BIT_IO_BIT4_OUT|
    SLVDSP1104_BIT_IO_BIT1_OUT);
...
static void rti_mdl_initialize_io_units(void)
{
  ...
  rti_slv1104_taskqueue_error[1] = ds1104_slave_dsp_bit_io_clear(1,
    rti_slv1104_fcn_index[13], SLVDSP1104_BIT_IO_BIT4_MSK|

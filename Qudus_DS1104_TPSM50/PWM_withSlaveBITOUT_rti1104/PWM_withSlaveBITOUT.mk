...
#
#  $RCSfile: rti1104.tmf $ $Revision: 2.102 $ $Date: 2020/08/18 11:52:35CEST $
...
MAKEFILE                       = PWM_withSlaveBITOUT.mk
...
COMPUTER                       = PCWIN64
MODEL                          = PWM_withSlaveBITOUT
MODULES                        = PWM_withSlaveBITOUT_data.c PWM_withSlaveBITOUT_trc_ptr.c
S_FUNCTIONS                    = 
S_FUNCTIONS_LIB                = 
SOLVER                         = 
NUMST                          = 1
...
MASTER_ANCHOR_DIR              = 
START_DIR                      = U:\Bureau\Qudus_DS1104_TPSM50
...
RTWCUST_INCLUDES = \
	"$(START_DIR)" \
	"$(START_DIR)\PWM_withSlaveBITOUT_rti1104" \

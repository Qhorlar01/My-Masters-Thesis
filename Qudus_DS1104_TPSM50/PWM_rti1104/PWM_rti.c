...
#define RTB_STRUCTURE_NAME             PWM_B
#define RTP_STRUCTURE_NAME             PWM_P
...
static time_T dsStepSize = 1.0E-5;
...
static void rti_mdl_initialize_io_boards(void)
{
  ...
  ds1104_bit_io_init(DS1104_DIO2_OUT|DS1104_DIO3_OUT);
}
...
static void rti_mdl_initialize_io_units(void)
{
  ...
  ds1104_bit_io_clear(DS1104_DIO2|DS1104_DIO3);
}

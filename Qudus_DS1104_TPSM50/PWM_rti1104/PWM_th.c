/************************ dSPACE target specific file *************************
   ...
   Include file .\PWM_rti1104\PWM_th.c :

   Task Configuration file for model : PWM

   RTI1104 23.1 (02-May-2023)/2.20
   04-Jul-2025 12:20:58
...
/* ===== List of model tasks and assigned interrupt sources ================
   ...
   Timer Task 1 [1e-05 0] s       : Timer A interrupt
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\PWM_rti1104\PWM_th.c is for ST).
# endif
...
/* Initialize dynamically generated services */
  ...
  rtith_bind_interrupt( /* --- Bind interrupt to task. ----- */
      ...
      pTask1,             /*  Task (TCB pointer).              */
      (1e-05 * RTI_TIMER_TASK_TIME_SCALE),             /*  Sample time or period.           */
      C_LOCAL,             /*  RTK channel.                     */
